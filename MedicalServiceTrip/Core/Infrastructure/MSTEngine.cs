...
{
    public class MSTEngine : IEngine
    {
        #region Properties
        ...
        /// <param name="typeFinder">Type finder</param>
        protected virtual IServiceProvider RegisterDependencies(MSTConfig nopConfig, IServiceCollection services, ITypeFinder typeFinder)
        {
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            var nopConfig = provider.GetRequiredService<MSTConfig>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new MSTException("Unknown dependency");
                        return service;
                    });
            ...
            throw new MSTException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
